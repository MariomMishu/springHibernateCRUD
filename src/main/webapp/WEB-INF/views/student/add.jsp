...
<div class="wrapper">
 ...
 <!-- Horizontal Form -->
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="${pageContext.request.contextPath }/student/add" modelAttribute="student">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                     ...
                     <form:select  class="form-control" path="country.countryCode">
						<form:options items="${country_list}" itemLabel="countryName" itemValue="countryCode" />
					</form:select></div>
                  </div>
                  <div class="form-group row">
                     <label  class="col-sm-2 col-form-label">Course</label>
                     <div class="col-sm-10">
                     	<form:select class="custom-select" path="courseCodes" multiple="true">
						<form:options items="${course_list}" itemLabel="courseName" itemValue="courseCode" />
						</form:select>
					</div>
                  </div>
                </div>
               ...
               <input type=submit class="btn Info" name="submit" value="Add">
                </div>
                <!-- /.card-footer -->
             </form:form>
            </div> </div>
